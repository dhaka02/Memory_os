...
int main(int argc, char const *argv[])
{
    ...
    */
    ...
    for(int i=0;i<10;i++){
        // ptr[0] = (int*)mems_malloc(16000);
        // printf("Virtual address: %lu\n", (unsigned long)ptr[0]);
        // ptr[1] = (int*)mems_malloc(20000);
        // printf("Virtual address: %lu\n", (unsigned long)ptr[1]);
        // ptr[2] = (int*)mems_malloc(20000);
        // printf("Virtual address: %lu\n", (unsigned long)ptr[2]);
        ptr[i] = (int*)mems_malloc(sizeof(int)*250);
        printf("Virtual address: %lu\n", (unsigned long)ptr[i]);

    }
        // int* phy_ptr= (&ptr[0][1]); // get the address of index 1
        // phy_ptr[0]=200; // put value at index 1
        // int* phy_ptr2= (&ptr[0][0]); // get the address of index 0
        ...
        // printf("Virtual address ptr[][0]: %lu\n", (unsigned long)&ptr[0][0]);
        // printf("Virtual address ptr[][1]: %lu\n", (unsigned long)&ptr[0][1]);
        // printf("Virtual address ptr[][2]: %lu\n", (unsigned long)&ptr[0][2]);
